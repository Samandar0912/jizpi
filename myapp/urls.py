...
urlpatterns = [
    ...
    path('kafedralar/', kafedra, name='kafedra_list'),  # Kafedralar ro'yxati uchun URL
    path('kafedralar/<int:pk>/', kafedra_detail, name='kafedra_detail'),  # Kafedra tafsilotlari uchun URL
